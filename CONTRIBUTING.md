# Contributing to workbench-cloud

This is a `workbench` ecosystem module — it doesn't stand alone. It's
installed into a machine via `workbench-core`'s `wb add cloud`. Full
...
```sh
git clone https://github.com/GingerGraham/workbench-cloud.git
cd workbench-cloud
...
wb dev cloud
# — or directly:
wb track cloud --branch <your-branch>
```
